...
export function JsonFormatterTool() {
  ...
  return (
    <div className="space-y-4">
      ...
      />
      <textarea value={input} onChange={(e) => setInput(e.target.value)} className="textarea h-40" style={{ borderColor: "var(--border)" }} />
      ...
      <textarea readOnly value={output} className="textarea h-40" style={{ borderColor: "var(--border)" }} />
    </div>
  );
}
